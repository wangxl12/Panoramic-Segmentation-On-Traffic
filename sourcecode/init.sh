#!/bin/bash
cd /usr/local;sudo ln -snf /usr/local/cuda-10.1 cuda
...
pip install detectron2-0.3+cu101-cp36-cp36m-linux_x86_64.whl -i https://pypi.tuna.tsinghua.edu.cn/simple/ --trusted-host=pypi.tuna.tsinghua.edu.cn/simple ipython
